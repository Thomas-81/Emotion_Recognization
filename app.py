...
#Create a function to detect the face in the frame
def detect_face(frame):
    gray=cv2.cvtColor(frame,cv2.COLOR_BGR2GRAY)
    face_cascade=cv2.CascadeClassifier('models/haarcascade_fontalface_default.xml')
...
st.title("Emotionn Detection using OPpenCV and Keras")
